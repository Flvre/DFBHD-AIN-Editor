...
Detailed usage is covered in [USER_GUIDE.md](USER_GUIDE.md). See [GENERATOR.md](GENERATOR.md) for generator behavior, [FILE_FORMATS.md](FILE_FORMATS.md) for the supported binary and text formats, [TROUBLESHOOTING.md](TROUBLESHOOTING.md) for common problems, and [CHANGELOG.md](CHANGELOG.md) for the v1.0 feature list.
